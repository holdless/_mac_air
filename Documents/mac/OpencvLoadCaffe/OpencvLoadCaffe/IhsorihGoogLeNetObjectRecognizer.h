//
//  IhsorihGoogLeNetObjectRecognizer.h
//  OpencvLoadCaffe
//
...
#ifndef IhsorihGoogLeNetObjectRecognizer_h
#define IhsorihGoogLeNetObjectRecognizer_h


#endif /* IhsorihGoogLeNetObjectRecognizer_h */
...
public:
    ...
    std::vector<String> readClassNames(string _synsetPath)
    {
    ...
    void init(string modelTxt, string modelBin, string synsetPath) {
